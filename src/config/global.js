export default {
  ...
  complementario: [
    ...
    {
      tema: 'Software de equipos',
      referencia:
        'IBM. (2021).<em> Procesos de instalación de software</em>. IBM. https://www.ibm.com/docs/es/i/7.3?topic=installation-software-process',
      tipo: 'Documentación ',
      link:
    ...
    },
    {
      tema: 'Mantenimiento preventivo',
      referencia:
        'LEVSA. (s.f).<em> La importancia de la lubricación en los equipos industriales.</em> LEVSA. https://levsalubricantes.com.mx/la-importancia-de-la-lubricacion-en-los-equipos-industriales/',
      tipo: 'Página web',
      link:
    ...
    },
    {
      ...
      referencia:
        'Ministerio de ambiente y desarrollo sostenible. (s.f.).<em> Residuos de Aparato Eléctricos y Electrónicos - RAEE.</em> Ministerio de ambiente y desarrollo sostenible. https://www.minambiente.gov.co/asuntos-ambientales-sectorial-y-urbana/residuos-de-aparato-electricos-y-electronicos-raee/',
      tipo: 'Pagina gubernamental ',
      link:
    ...
    },
    {
      ...
      referencia:
        'TodaMateria. (2022).<em> ¿Qué es software? </em>TodaMateria. https://www.todamateria.com/que-es-software/#:%7E:text=El%20software%20es%20el%20conjunto,programas%20y%20los%20sistemas%20operativos.',
      tipo: 'Página web',
      link:
    ...
    },
    {
      tema: 'Concepto de programación',
      referencia:
        'Xunta.gal. (s.f.).<em> Programación 1819.</em> Xunta.gal. https://www.edu.xunta.gal/centros/iesblancoamorculleredo/aulavirtual/mod/book/view.php?id=19963&chapterid=4292',
      tipo: 'Blog',
      link:
