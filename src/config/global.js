export default {
  global: {
    ...
    descripcionCurso:
      'La intervención de equipos eléctricos y electrónicos dentro de una organización es clave a la hora de mantener en óptimas condiciones cada uno de los dispositivos. Dentro de las estrategias para dar con el objetivo anterior se tiene la instalación de <em>software</em>, el mantenimiento correctivo y el preventivo, la reparación de fallas y el diseño e interpretación de algoritmos. Este último muy necesario a la hora de resolver problemas mediados por la utilización de autómatas programables, cambios requeridos o correcciones a los algoritmos existentes dentro de una empresa.',
        ...
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '6.1',
            titulo: 'Algoritmos y diagramas de flujo',
            hash: 't_6_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '6.2',
            titulo: 'Introducción a los autómatas programables',
            hash: 't_6_2',
          },
        ],
      },
  ...
  complementario: [
    ...
    {
      tema: 'Instalación de <em>software</em>',
      referencia:
  ...
  glosario: [
    ...
    },
    {
      termino: 'Contactor',
      significado:
        'El contactor o switch es un elemento electrónico que de acuerdo con una acción mecánica permite o no el paso de corriente.',
    },
    {
      termino: 'Contadores',
      significado:
  ...
  referencias: [
    {
      referencia:
        'Área metropolitana Valle de Aburra. (2019). <em>Eficiencia Energética. Futuro sostenible</em>.',
      link:
        'https://www.metropol.gov.co/ambiental/Paginas/consumo-sostenible/eficiencia-energetica.aspx',
    },
    {
      referencia:
        'Cardenas, F. (s.f). <em>Diagrama de flujo de proceso: qué es, cómo se hace y ejemplos</em>. HubSpot.',
      link: 'https://blog.hubspot.es/sales/que-es-diagrama-flujo-procesos',
    },
    {
      referencia:
        'Domingo, J., Grau, A., Martínez, H y Gázmin, J. (2003). <em>Diseño y aplicaciones con autómatas programables</em>. Universitat Oberta de Catalunya.',
    },
    {
      referencia:
        'Herrera, A., Capacho, J y Ebratt, R. (2015). <em>Diseño y construcción de algoritmos</em>. Alianza Editorial.',
    },
    {
      referencia:
    ...
    {
      referencia:
        'Martín, P., Oliva, J y Manjavacas, Z. (2014). <em>Montaje y mantenimiento de equipos 2.a edición</em>. Paraninfo.',
    },
    {
      referencia:
        'Ministerio de ambiente y desarrollo sostenible. (s.f). <em>Residuos Peligrosos</em>. Ministerio de ambiente y desarrollo sostenible.',
      link:
    ...
    {
      referencia:
        'Secretaría de Habitad Servicio de Higiene y Seguridad. (s.f). <em>Normas de Seguridad para Manipular Residuos Peligrosos: Higiene y Seguridad</em>. UBAEXACTAS.',
      link:
